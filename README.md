...
as misses; wins record the account. *Settings > Results* and `--report` show, per account: entered, unconfirmed,
skipped, missed, the share caught, wins and median entrants.
...
.venv\Scripts\python -m pytest -q             # 395 tests
```
