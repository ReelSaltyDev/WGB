...
class AndroidDevice:
    def __init__(self, name: str, serial: str, dcfg: DeviceCfg, pacing: PacingCfg,
        ...
        # The last screen open_show read while waiting to arrive (None: none yet in this open). A stream link that did
        # not land is looked at for Whatnot's sign-in screen in this, with no read of its own (Camper._sign_in_on_open).
        self.arrival_read: list[dict] | None = None
    ...
    def open_show(self, url: str) -> None:
        ...
        """
        self._last_url = url
        self.arrival_read = None        # never a screen from an earlier open
